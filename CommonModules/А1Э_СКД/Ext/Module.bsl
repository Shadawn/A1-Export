...
//  Настройки				 - Структура - Может содержать ключи:
...
//    
//  Результат				 - ТабличныйДокумент, ТаблицаЗначений, ДеревоЗначений - 
...
Функция ДобавитьОтбор(КоллекцияНастроек, Имя, Значение, Знач ВидСравнения = "Равно") Экспорт
	Настройки = А1Э_СтандартныеТипы.НастройкиКомпоновкиДанныхПолучить(КоллекцияНастроек);	
	ВидСравнения = А1Э_СтандартныеТипы.ВидСравненияКомпоновкиДанныхПолучить(ВидСравнения);
	
	УдалитьОтборИзЭлементов(Настройки.Отбор.Элементы, Имя, ВидСравнения);
	ДобавитьОтборВЭлементы(Настройки.Отбор.Элементы, Имя, ВидСравнения, Значение); 
КонецФункции
...
Функция УдалитьОтбор(КоллекцияНастроек, Имя, Знач ВидСравнения = "Равно") Экспорт
	...
	Возврат УдалитьОтборИзЭлементов(Настройки.Отбор.Элементы, Имя, ВидСравнения);
КонецФункции

#Область Служебно_Сервер

Функция ДобавитьОтборВЭлементы(КоллекцияЭлементов, Имя, ВидСравнения, Значение) 
...
Функция УдалитьОтборИзЭлементов(КоллекцияЭлементов, Имя, ВидСравнения)
	Удалено = Ложь;
