#Если НЕ Клиент Тогда
	...
	Функция МенеджерТипаОбъектов(Знач ТипОбъекта) Экспорт
		...
		ИначеЕсли Идентификатор = "ПЛА" Тогда
			Подстрока1 = ?(Сред(ТипОбъекта, 5, 1) = "Ы", Сред(ТипОбъекта, 6), Сред(ТипОбъекта, 5));
			Если Лев(Подстрока1, 3) = "СЧЕ" Тогда Возврат ПланыСчетов; КонецЕсли;
			Подстрока2 = Сред(Подстрока1, 6, 3);
			Если Подстрока2 = "ХАР" Тогда Возврат ПланыВидовХарактеристик;
			ИначеЕсли Подстрока2 = "РАС" Тогда Возврат ПланыВидовРасчета;
			КонецЕсли;
		КонецЕсли;
