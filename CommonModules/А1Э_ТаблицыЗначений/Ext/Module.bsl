...
Функция ВыгрузитьКолонку(Таблица, Колонка) Экспорт
	...
	Для Каждого Строка Из Таблица Цикл
		Если ТипЗнч(Строка) = Тип("Структура") Тогда
			Результат.Добавить(А1Э_Структуры.ЗначениеСвойства(Строка, Колонка));
		Иначе
			Результат.Добавить(Строка[Колонка]);
		КонецЕсли;
	КонецЦикла;
	Возврат Результат;
КонецФункции
...
Функция Сортировать(Таблица, Знач Колонки) Экспорт
	#Если НЕ Клиент Тогда
		Если ТипЗнч(Таблица) = Тип("ТаблицаЗначений") Тогда
			Возврат Таблица.Сортировать(Колонки);
		КонецЕсли;
	#КонецЕсли
...
#Если НЕ Клиент Тогда
	...
	//    Структура - описывает другие варианты распознавания. 
	//      "ПоРеквизиту" - см. функцию "ВариантРаспознаванияПоРеквизиту".
	//      "ПоДопРеквизиту" - необходимо передать также поля "ВидРеквизита" ("ДР" по умолчению), "Реквизит" и (если "ВидРеквизита"="ДР") "Объект". Работает аналогично
	//        "ПоРеквизиту", по использует ДопРеквизит.
	//      "Реквизит" - см. функцию "ВариантРаспознаванияРеквизит".
	//		"ДопРеквизит" - см. функцию 
	//	
	...
	// Функция - Распознать колонки. См. функцию А1Э_ТаблицыЗначений.РаспознатьКолонку
...
Функция ВариантРаспознаванияРеквизит(Объект, Реквизит) Экспорт 
	Возврат Новый Структура("ВариантРаспознавания,Объект,Реквизит", "Реквизит", Объект, Реквизит);	
КонецФункции

Функция ВариантРаспознаванияДопРеквизит(Реквизит, ВидРеквизита = "ДР") Экспорт
	Возврат Новый Структура("ВариантРаспознавания,Реквизит,ВидРеквизита", "ДопРеквизит", Реквизит, ВидРеквизита);	
КонецФункции
...
Функция ВариантРаспознаванияПоРеквизиту(Объект, Реквизит) Экспорт
	Возврат Новый Структура("ВариантРаспознавания,Объект,Реквизит", "ПоРеквизиту", Объект, Реквизит);
КонецФункции
