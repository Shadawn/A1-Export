...
#Если Не Клиент Тогда
	...
	Функция СоздатьКомандуПоОписанию(Форма, ОписаниеКоманды) Экспорт 
		...
		СочетаниеКлавиш = А1Э_Структуры.ЗначениеСвойства(ОписаниеКоманды.Параметры, "СочетаниеКлавиш");
		Если СочетаниеКлавиш <> Неопределено Тогда
			Если ТипЗнч(СочетаниеКлавиш) = Тип("Строка") Тогда
				Если А1Э_Строки.ТолькоЦифры(Лев(СочетаниеКлавиш, 1)) Тогда
					СочетаниеКлавиш = "_" + СочетаниеКлавиш;
				КонецЕсли;
				СочетаниеКлавиш = Новый СочетаниеКлавиш(Клавиша[СочетаниеКлавиш]);
			КонецЕсли;
