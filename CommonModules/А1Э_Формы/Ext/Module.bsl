...
Функция МетаданныеВладельцаФормы(Форма) Экспорт
	Возврат А1Э_Метаданные.ОбъектМетаданных(ИмяМетаданныхВладельцаФормы(Форма));
КонецФункции

Функция ИмяМетаданныхВладельцаФормы(Форма) Экспорт
	ИмяФормы = Форма.ИмяФормы;
	ВтораяТочка = СтрНайти(ИмяФормы, ".", , , 2);
	Возврат ?(ВтораяТочка = 0, ИмяФормы, Лев(ИмяФормы, ВтораяТочка - 1));
КонецФункции
