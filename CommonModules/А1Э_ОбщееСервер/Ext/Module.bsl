...
// Получает реквизит ссылки. Можно обращаться к реквизиту реквизита через ".". Можно обращаться к строкам табличных частей с указанием номера строки.
// Пример: Реквизит(Ссылка, "Поставщики.0.ЗаказПоставщику.Контрагент") получает контрагента заказа первой строки табличной части "Поставщики".
//
// Параметры:
//  Ссылка		 - ЛюбаяСсылка - 
//  ИмяРеквизита - Строка	 - 
...
Функция Реквизит(Ссылка, ИмяРеквизита) Экспорт
    Реквизиты = СтрРазделить(ИмяРеквизита, ".");
    Результат = Ссылка;
    Для Каждого Реквизит Из Реквизиты Цикл
        Если А1Э_Строки.ТолькоЦифры(Реквизит) Тогда
            Реквизит = Число(Реквизит);
        КонецЕсли;
