...
// Возвращает структуру с двумя ключами - <Перед> и <После>, содержащими части строки, разделенные по искомой подстроке.
// Сама подстрока не включается. Если подстрока не найдена, <Перед> = Строка, <После> = "".
//
// Параметры:
//  Строка		 - Строка - исходная строка.
//  Подстрока	 - Строка - подстрока для поиска.
...
// Заменяет в исходной строке ПодстрокуПоиска на ПодстрокуЗамены
//
// Параметры:
...
#Если Клиент Тогда
	...
	// Выводит строку на экран (в виде табличного документа).
	//
	// Параметры:
	//  Строка	 - Строка - 
	// 
...
#Если НЕ Клиент Тогда
	...
	// Получает строку из макета текстового документа.
	//
	// Параметры:
