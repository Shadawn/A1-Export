...
// Функция используется для того, чтобы писать читаемые и открываемые констрктором запросы к данным других расширений. 
//
// Параметры:
//  ТекстЗапроса - Строка -  
//  Шаблон		 - Строка - 
...
Функция ПараметрыПериодаПоКомпоновщику(КомпоновщикНастроек, Настройки) Экспорт
